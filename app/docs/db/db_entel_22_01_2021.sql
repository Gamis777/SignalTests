...
CREATE TABLE IF NOT EXISTS `db_entel`.`pruebas` (
  ...
  `activo` ENUM('S', 'N') NULL,
  `programacion` VARCHAR(1) NULL,
  `ejecutado` ENUM('S', 'N') NULL,
...
CREATE TABLE IF NOT EXISTS `db_entel`.`ejecuciones` (
  ...
  INDEX `fk_ejecuciones_pruebas1_idx` (`id_prueba` ASC),
  CONSTRAINT `fk_ejecuciones_pruebas1`
    FOREIGN KEY (`id_prueba`)
    REFERENCES `db_entel`.`pruebas` (`id_prueba`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_entel`.`registros_claves`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_entel`.`registros_claves` (
  `id_registro_clave` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `db_entel`.`canales_claves`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_entel`.`canales_claves` (
  `id_canal` INT NOT NULL,
  `id_registro_clave` INT NOT NULL,
  INDEX `fk_canales_claves_canales1_idx` (`id_canal` ASC),
  INDEX `fk_canales_claves_registros_claves1_idx` (`id_registro_clave` ASC),
  CONSTRAINT `fk_canales_claves_canales1`
    FOREIGN KEY (`id_canal`)
    REFERENCES `db_entel`.`canales` (`id_canal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_canales_claves_registros_claves1`
    FOREIGN KEY (`id_registro_clave`)
    REFERENCES `db_entel`.`registros_claves` (`id_registro_clave`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `db_entel`.`ldap`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_entel`.`ldap` (
)
ENGINE = InnoDB;
